class Graph:
    ...
    def add_v(self, name, label=None, mark=None):
        ...
        if label is not None:
            self.vertices[-1] = label
        if mark is not None:
            self.vertices[-1] = mark
    ...
    def del_v(self, v):
        ...
        del self.vertices[self.vertices.index(v)]
    ...
    def edit_v(self, v, new_label=None, new_mark=None):
        ...
        if new_label is not None:
            self.vertices[self.vertices.index(v)] = new_label
        if new_mark is not None:
            self.vertices[self.vertices.index(v)] = new_mark
